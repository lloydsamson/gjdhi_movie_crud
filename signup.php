...
<main>
    <div class="form-content">
        <div class="form__content__inner">
            <h1 id="header-login-signup">Sign Up</h1>
            ...
            <form onsubmit="onSubmit(event)">
                ...
                <input type="submit" value="Register" name="login" id="submit-btn">
            </form>
            <hr>
            <div class="form-footer">
                <p id="form-footer">Already have an account? <a href="index.php">Sign In</a></p>
            </div>
        </div>
    </div>
</main>
